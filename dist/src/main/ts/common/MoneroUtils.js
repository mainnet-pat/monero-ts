...
class MoneroUtils {
  ...
  static async getIntegratedAddress(networkType, standardAddress, paymentId) {
    ...
    if (_LibraryUtils.default.getWasmModule() === undefined) await _LibraryUtils.default.loadFullModule();
