...
class MoneroRpcConnection {
  ...
  async checkConnection(timeoutMs) {
    return this.queueCheckConnection(async () => {
      await _LibraryUtils.default.loadFullModule(); // cache wasm for binary request
